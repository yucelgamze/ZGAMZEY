class ZCL_ZGY_TEST_DPC definition
  public
...
protected section.
  ...
  methods TOTALQUANTITYSET_UPDATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZGY_TEST_MPC=>TS_TOTALQUANTITY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods TOTALQUANTITYSET_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGY_TEST_MPC=>TT_TOTALQUANTITY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods TOTALQUANTITYSET_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods TOTALQUANTITYSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods TOTALQUANTITYSET_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods ORDERITEMSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGY_TEST_MPC=>TS_ORDERITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ORDERITEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGY_TEST_MPC=>TT_ORDERITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ORDERHEADERSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGY_TEST_MPC=>TS_ORDERHEADER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ORDERHEADERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGY_TEST_MPC=>TT_ORDERHEADER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods HTVAKSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGY_TEST_MPC=>TS_HTVAK
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods HTVAKSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGY_TEST_MPC=>TT_HTVAK
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FILESSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGY_TEST_MPC=>TS_FILES
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods FILESSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGY_TEST_MPC=>TT_FILES
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGY_TEST_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 28.11.2023 18:44:07 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGY_TEST_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA orderheaderset_create_entity TYPE zcl_zgy_test_mpc=>ts_orderheader.
 DATA filesset_create_entity TYPE zcl_zgy_test_mpc=>ts_files.
 DATA orderitemset_create_entity TYPE zcl_zgy_test_mpc=>ts_orderitem.
 DATA totalquantityset_create_entity TYPE zcl_zgy_test_mpc=>ts_totalquantity.
 DATA htvakset_create_entity TYPE zcl_zgy_test_mpc=>ts_htvak.
...
*-------------------------------------------------------------------------*
*             EntitySet -  TotalQuantitySet
*-------------------------------------------------------------------------*
     WHEN 'TotalQuantitySet'.
*     Call the entity set generated method
    totalquantityset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = totalquantityset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = totalquantityset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'TotalQuantitySet'.
*     Call the entity set generated method
     totalquantityset_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA orderheaderset_get_entity TYPE zcl_zgy_test_mpc=>ts_orderheader.
 DATA orderitemset_get_entity TYPE zcl_zgy_test_mpc=>ts_orderitem.
 DATA totalquantityset_get_entity TYPE zcl_zgy_test_mpc=>ts_totalquantity.
 DATA htvakset_get_entity TYPE zcl_zgy_test_mpc=>ts_htvak.
 DATA filesset_get_entity TYPE zcl_zgy_test_mpc=>ts_files.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          totalquantityset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = totalquantityset_get_entity
                         es_response_context = es_response_context
          ).

        IF totalquantityset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = totalquantityset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGY_TEST_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA orderheaderset_get_entityset TYPE zcl_zgy_test_mpc=>tt_orderheader.
 DATA orderitemset_get_entityset TYPE zcl_zgy_test_mpc=>tt_orderitem.
 DATA totalquantityset_get_entityset TYPE zcl_zgy_test_mpc=>tt_totalquantity.
 DATA htvakset_get_entityset TYPE zcl_zgy_test_mpc=>tt_htvak.
 DATA filesset_get_entityset TYPE zcl_zgy_test_mpc=>tt_files.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'TotalQuantitySet'.
*     Call the entity set generated method
      totalquantityset_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = totalquantityset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = totalquantityset_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA filesset_update_entity TYPE zcl_zgy_test_mpc=>ts_files.
 DATA htvakset_update_entity TYPE zcl_zgy_test_mpc=>ts_htvak.
 DATA totalquantityset_update_entity TYPE zcl_zgy_test_mpc=>ts_totalquantity.
 DATA orderitemset_update_entity TYPE zcl_zgy_test_mpc=>ts_orderitem.
 DATA orderheaderset_update_entity TYPE zcl_zgy_test_mpc=>ts_orderheader.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'TotalQuantitySet'.
*     Call the entity set generated method
          totalquantityset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = totalquantityset_update_entity
          ).
       IF totalquantityset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = totalquantityset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
ENDLOOP.
  ...
  method TOTALQUANTITYSET_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'TOTALQUANTITYSET_CREATE_ENTITY'.
  ...
  method TOTALQUANTITYSET_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'TOTALQUANTITYSET_DELETE_ENTITY'.
  ...
  method TOTALQUANTITYSET_GET_ENTITY.
*-------------------------------------------------------------
*  Data declaration
*-------------------------------------------------------------
 DATA ev_message TYPE zif_zgy_fm_toplam_miktar=>bapi_msg.
 DATA ev_success TYPE zif_zgy_fm_toplam_miktar=>xfeld.
 DATA ev_total TYPE zif_zgy_fm_toplam_miktar=>char10.
 DATA iv_vbeln TYPE zif_zgy_fm_toplam_miktar=>vbeln.
...
* Maps key fields to function module parameters
 ...
 IF lv_source_entity_set_name = 'TotalQuantitySet' AND
...
* Map properties from the backend to the Gateway output response structure
 ...
 er_entity-message = ev_message.
  ...
  method TOTALQUANTITYSET_GET_ENTITYSET.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'TOTALQUANTITYSET_GET_ENTITYSET'.
  ...
  method TOTALQUANTITYSET_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'TOTALQUANTITYSET_UPDATE_ENTITY'.
