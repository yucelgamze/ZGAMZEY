...
CLASS lcl_local IMPLEMENTATION.
  METHOD get_data.
    ...
    vkorg ,
    vtweg
    FROM vbak WHERE vbak~vbeln IN @so_vbeln
...
*         i_parent = cl_gui_container=>screen0.
  ...
  METHOD print.
    ...
    IF lt_index_rows IS INITIAL.
      ...
      MESSAGE |Satır seçilmedi!| TYPE 'I' DISPLAY LIKE 'W'.
    ELSE.

      LOOP AT lt_index_rows INTO DATA(ls_index_rows).

        READ TABLE gt_alv ASSIGNING FIELD-SYMBOL(<lfs_alv>) INDEX ls_index_rows-index.
    ...
    IF sy-subrc EQ 0.
      ...
      waerk,
      werks
      FROM vbap                               "eğer üstteki select bir itab verseydi for all entries in itab sonrasında where...
