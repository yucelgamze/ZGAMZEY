class ZCL_ZGY_PO_DETAILS_MPC definition
  public
...
CLASS ZCL_ZGY_PO_DETAILS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGY_PO_DETAILS_SRV' ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PurMat' iv_abap_fieldname = 'PUR_MAT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 18 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'MATN5' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20231204125016'.                  "#EC NOTEXT
