class ZCL_ZGY_ASS_MPC definition
  public
...
public section.
  ...
  types:
         TS_PO_ITEMS type BAPIEKPO .
  types:
    TT_PO_ITEMS type standard table of TS_PO_ITEMS .

  constants GC_PO_HEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PO_HEADER' ##NO_TEXT.
  constants GC_PO_ITEMS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PO_ITEMS' ##NO_TEXT.
...
CLASS ZCL_ZGY_ASS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGY_ASS_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'PO_ASSOCIATION' "#EC NOTEXT
                            iv_left_type        = 'PO_HEADER' "#EC NOTEXT
                            iv_right_type       = 'PO_ITEMS' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - PO_ASSOCIATION
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'PoNumber'   iv_dependent_property = 'PoNumber' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'PO_ASSOCIATIONSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'PO_HEADERSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'PO_ITEMSSet'             "#EC NOTEXT
                                              iv_association_name      = 'PO_ASSOCIATION' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NP_PO' "#EC NOTEXT
                                                              iv_abap_fieldname = 'NP_PO' "#EC NOTEXT
                                                              iv_association_name = 'PO_ASSOCIATION' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIEKKOL'
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PO_ITEMS' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIEKPO'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PO_ITEMSSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20231204133030'.                  "#EC NOTEXT
